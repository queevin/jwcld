...
<div class='span4 pull-right'>
    <div class='row-fluid'>
        <strong>学年学期</strong>
        <form id="form1" method="post" action="<?php echo U('Analysis/department');?>">
...
<div class='row-fluid'>
    <div class='span12 box bordered-box green-border' style='margin-bottom:0;'>
        <div class='box-header green-background'>
            <div class='text-center'><?php echo ($year); ?>-<?php echo ($year+1); ?>学年&nbsp;&nbsp;<?php echo ($term); ?>学期领导听课统计总表（按院系统计）</div>
            <?php if($_SESSION['userRole']< 5): ?><a class='btn btn-success btn-large' style='position: absolute;left:100px;top:2px;' href="<?php echo U('Analysis/outportLd',array('tid'=>2));?>">
              ...
              <div class='scrollable-area' id="table_analysis">
                <table  class='table table-bordered table-hover table-striped' style='margin-bottom:0;'>
                  <thead>
                    ...
                    <tr>
                        <th rowspan='2' nowrap>教师单位</th>
                        <th rowspan='2'>听课领导人数</th>
                        <th colspan='3' style="text-align:center">听课次数</th>
                  ...
                  <tbody>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["ldrs"]); ?></td>
                        <td><?php echo ($vo["ztkcs"]); ?></td>
                        <td><?php echo ($vo["tkcsbk"]); ?></td>
                        <td><?php echo ($vo["tkcsyjs"]); ?></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#smanager').nav_slide('smanager','department');
        $('#selYt').change(function(){
            $('#form1').submit();
        });
        $('#exportBtn').click(function(){
            $('#table_analysis').printArea();
            /*$('#table_analysis').tableExport({
                type:'csv',
                separator:',',
                tableName:'data.csv',
                escape:'true',
